        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artists_SubCompetitions_SubCompetitionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Predictions_Artists_ArtistId",
                        column: x => x.ArtistId,
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Predictions_SubCompetitions_SubCompetitionId",
                        column: x => x.SubCompetitionId,
                        principalTable: "SubCompetitions",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResultsOfSubCompetitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResultsOfSubCompetitions_Artists_ArtistId",
                        column: x => x.ArtistId,
                        principalTable: "Artists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ResultsOfSubCompetitions_SubCompetitions_SubCompetitionId",
                        column: x => x.SubCompetitionId,
                        principalTable: "SubCompetitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Artists_SubCompetitionId",
                table: "Artists",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Predictions_ArtistId",
                table: "Predictions",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_SubCompetitionId",
                table: "Predictions",
                column: "SubCompetitionId");

            migrationBuilder.CreateIndex(
                name: "IX_Predictions_UserId_SubCompetitionId",
                table: "Predictions",
                columns: new[] { "UserId", "SubCompetitionId" });

            migrationBuilder.CreateIndex(
                name: "IX_ResultsOfSubCompetitions_ArtistId",
                table: "ResultsOfSubCompetitions",
                column: "ArtistId");

            migrationBuilder.CreateIndex(
                name: "IX_ResultsOfSubCompetitions_SubCompetitionId",
                table: "ResultsOfSubCompetitions",
                column: "SubCompetitionId");
