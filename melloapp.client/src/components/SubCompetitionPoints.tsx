    ...
    return (
        <Box sx={{
            ...
            {subCompetitionData.map((entry, index) => {
                // Create a sorted copy of userScores: by points descending, then by firstName ascending
                const sortedUserScores = [...entry.userScores].sort((a, b) => {
                ...
                return (
                    ...
                    >
                        ...
                        <List>
                            {sortedUserScores.map((userScore, idx) => (
